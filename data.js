...
const TRIP = {
  ...
  openItems: [
    ...
    { text: "Book the one-way rental car, Liepāja → Palanga — confirm the agency supports dropping in Palanga specifically" },
    { text: "Book the Palanga–Klaipėda bus" },
    { text: "Book accommodation: Nida (2 nights), Vilnius (2 nights)" },
